...
if 'Thời gian (UTC)' in lake_df.columns:
    ...
    # We can plot manually or use plot_importance
    xgb.plot_importance(model, importance_type='weight', max_num_features=len(features), ax=plt.gca(), color='teal')
    ...
    import joblib
    joblib.dump(model, "xgboost_flood_model.pkl")
    print("Model saved to xgboost_flood_model.pkl")
